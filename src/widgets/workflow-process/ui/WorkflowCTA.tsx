    ...
    <div className="py-20 px-6 relative z-10">
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(255,255,255,0.4) 0%, rgba(76,2,251,0.2) 40%, transparent 70%)',
            filter: 'blur(60px)',
          }}
          aria-hidden="true"
        />
        <div
          ...
          style={{
            background:
              'radial-gradient(circle, rgba(255,255,255,0.4) 0%, rgba(224,93,114,0.2) 40%, transparent 70%)',
            filter: 'blur(60px)',
          }}
          aria-hidden="true"
        />
        ...
        <Button
          ...
          style={{
            boxShadow:
              '0 4px 20px rgba(76,2,251,0.3), inset 0 1px 0 rgba(255,255,255,0.2)',
          }}
        >
          {t('button')}
